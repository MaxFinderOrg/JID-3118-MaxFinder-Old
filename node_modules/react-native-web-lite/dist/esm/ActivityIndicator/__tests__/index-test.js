...
describe("components/ActivityIndicator", () => {
  ...
  describe('prop "animating"', () => {
    test('is "true"', () => {
      const { container } = render(/* @__PURE__ */ jsx(ActivityIndicator, { animating: true }));
      expect(container.firstChild).toMatchSnapshot();
    });
    test('is "false"', () => {
      const { container } = render(/* @__PURE__ */ jsx(ActivityIndicator, { animating: false }));
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  test('prop "color"', () => {
    const { container } = render(/* @__PURE__ */ jsx(ActivityIndicator, { color: "red" }));
  ...
  describe('prop "hidesWhenStopped"', () => {
    test('is "true"', () => {
      const { container } = render(
        /* @__PURE__ */ jsx(ActivityIndicator, { animating: false, hidesWhenStopped: true })
      );
      expect(container.firstChild).toMatchSnapshot();
    });
    test('is "false"', () => {
      const { container } = render(
        /* @__PURE__ */ jsx(ActivityIndicator, { animating: false, hidesWhenStopped: false })
      );
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  ...
  describe('prop "ref"', () => {
    test("value is set", () => {
      const ref = jest.fn();
      render(/* @__PURE__ */ jsx(ActivityIndicator, { ref }));
