...
describe("components/TextInput", () => {
  describe('prop "autoComplete"', () => {
    test('value "on"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, {}));
      const input = findInput(container);
      expect(input.getAttribute("autoComplete")).toEqual("on");
    });
    test('value "off"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { autoComplete: "off" }));
      const input = findInput(container);
      expect(input.getAttribute("autoComplete")).toEqual("off");
    });
    test("autoCompleteType fallback", () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { autoCompleteType: "off" }));
      const input = findInput(container);
      expect(input.getAttribute("autoComplete")).toEqual("off");
    });
  });
  describe('prop "autoFocus"', () => {
    ...
    test('value "true"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { autoFocus: true }));
      const input = findInput(container);
  ...
  describe('prop "clearTextOnFocus"', () => {
    ...
    testIfDocumentIsFocused('value "false"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { defaultValue }));
      const input = findInput(container);
      input.focus();
    ...
    testIfDocumentIsFocused('value "true"', () => {
      const { container } = render(
        /* @__PURE__ */ jsx(TextInput, { clearTextOnFocus: true, defaultValue })
      );
      const input = findInput(container);
      input.focus();
  ...
  describe('prop "disabled"', () => {
    ...
    test('value "true"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { disabled: true }));
      const input = findInput(container);
  ...
  describe('prop "editable"', () => {
    ...
    test('value "false"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { editable: false }));
      const input = findInput(container);
  ...
  describe('prop "keyboardType"', () => {
    test("default value", () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { keyboardType: "default" }));
      const input = findInput(container);
      expect(input.type).toEqual("text");
    });
    test('value "email-address"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { keyboardType: "email-address" }));
      const input = findInput(container);
      expect(input.type).toEqual("email");
    });
    test('value "decimal-pad"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { keyboardType: "decimal-pad" }));
      const input = findInput(container);
      expect(input.inputMode).toEqual("decimal");
    });
    test('value "number-pad"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { keyboardType: "number-pad" }));
      const input = findInput(container);
      expect(input.inputMode).toEqual("numeric");
    });
    test('value "numeric"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { keyboardType: "numeric" }));
      const input = findInput(container);
      expect(input.inputMode).toEqual("numeric");
    });
    test('value "phone-pad"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { keyboardType: "phone-pad" }));
      const input = findInput(container);
      expect(input.type).toEqual("tel");
    });
    test('value "url"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { keyboardType: "url" }));
      const input = findInput(container);
      expect(input.type).toEqual("url");
    });
  });
  test('prop "maxLength"', () => {
    let { container } = render(/* @__PURE__ */ jsx(TextInput, {}));
    let input = findInput(container);
    expect(input.getAttribute("maxLength")).toEqual(null);
    ({ container } = render(/* @__PURE__ */ jsx(TextInput, { maxLength: 10 })));
  ...
  describe('prop "multiline"', () => {
    ...
    test('value "true"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { multiline: true }));
  ...
  describe('prop "numberOfLines"', () => {
    test('without "multiline"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { numberOfLines: 2 }));
      const input = findInput(container);
      const textarea = findTextArea(container);
      expect(input).toBeDefined();
    ...
    test('with "multiline"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { multiline: true, numberOfLines: 3 }));
      const textarea = findTextArea(container);
  ...
  test.skip('prop "onChange"', () => {
    ...
    const { container } = render(/* @__PURE__ */ jsx(TextInput, { onChange }));
    const input = findInput(container);
  ...
  test.skip('prop "onChangeText"', () => {
    ...
    const { container } = render(/* @__PURE__ */ jsx(TextInput, { onChangeText }));
    const input = findInput(container);
  ...
  describe('prop "onKeyPress"', () => {
    test("arrow key", () => {
      ...
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { onKeyPress }));
      const input = findInput(container);
  ...
  describe('prop "onSelectionChange"', () => {
    ...
    test.skip("is called on change", () => {
      ...
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { onSelectionChange }));
      const input = findInput(container);
  ...
  describe('prop "onSubmitEditing"', () => {
    ...
    test("multi-line input", () => {
      const onSubmitEditing = jest.fn();
      const { container } = render(
        /* @__PURE__ */ jsx(TextInput, { defaultValue: "12345", multiline: true, onSubmitEditing })
      );
      const textarea = findTextArea(container);
  ...
  test('prop "returnKeyType"', () => {
    ...
    const { container } = render(/* @__PURE__ */ jsx(TextInput, { returnKeyType }));
    const input = findInput(container);
    expect(input.getAttribute("enterkeyhint")).toEqual(returnKeyType);
  });
  test('prop "secureTextEntry"', () => {
    let { container } = render(/* @__PURE__ */ jsx(TextInput, { secureTextEntry: true }));
    const input = findInput(container);
    expect(input.getAttribute("type")).toEqual("password");
    ({ container } = render(/* @__PURE__ */ jsx(TextInput, { multiline: true, secureTextEntry: true })));
    const textarea = findTextArea(container);
    expect(textarea.getAttribute("type")).toEqual(null);
  });
  describe('prop "selectTextOnFocus"', () => {
    testIfDocumentIsFocused('value "false"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { defaultValue: "text" }));
      const input = findInput(container);
      input.focus();
  ...
  describe('prop "selection"', () => {
    test("set cursor location", () => {
      ...
      const { container: defaultContainer } = render(/* @__PURE__ */ jsx(TextInput, { defaultValue: "12345" }));
  ...
  describe('prop "spellCheck"', () => {
    ...
    test('inherit from "autoCorrect"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { autoCorrect: false }));
      const input = findInput(container);
      expect(input.getAttribute("spellCheck")).toEqual("false");
    });
    test('value "false"', () => {
      const { container } = render(/* @__PURE__ */ jsx(TextInput, { spellCheck: false }));
      const input = findInput(container);
      expect(input.getAttribute("spellCheck")).toEqual("false");
    });
  });
  test('prop "value"', () => {
    const value = "value";
    const { container } = render(/* @__PURE__ */ jsx(TextInput, { value }));
    const input = findInput(container);
  ...
  describe("imperative methods", () => {
    test("node.clear()", () => {
      const ref = React.createRef();
      render(/* @__PURE__ */ jsx(TextInput, { ref }));
