...
describe("exports/createElement/index.js", () => {
  test("renders different DOM elements", () => {
    ...
    ({ container } = (0, import_react.render)((0, import__.default)("main")));
    expect(container.firstChild).toMatchSnapshot();
    ({ container } = (0, import_react.render)(
  ...
  describe('prop "accessibilityRole"', () => {
    ...
    test("function component type", () => {
      ...
      const { container } = (0, import_react.render)((0, import__.default)(Custom, { accessibilityRole: "link" }));
  ...
  describe("accessibility props", () => {
    ...
    test("accessibilityAtomic", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityAtomic: true })
      );
    ...
    test("accessibilityAutoComplete", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityAutoComplete: true })
      );
    ...
    test("accessibilityBusy", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityBusy: true })
      );
    ...
    test("accessibilityChecked", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityChecked: true })
      );
    ...
    test("accessibilityDisabled", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("button", { accessibilityDisabled: true })
      );
    ...
    test("accessibilityExpanded", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityExpanded: true })
      );
    ...
    test("accessibilityHasPopup", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityHasPopup: true })
      );
    ...
    test("accessibilityHidden", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityHidden: true })
      );
    ...
    test("accessibilityInvalid", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("input", { accessibilityInvalid: true })
      );
    ...
    test("accessibilityModal", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityModal: true })
      );
    ...
    test("accessibilityMultiline", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityMultiline: true })
      );
    ...
    test("accessibilityMultiSelectable", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityMultiSelectable: true })
      );
    ...
    test("accessibilityPressed", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilityPressed: true })
      );
    ...
    test("accessibilityReadOnly", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("input", { accessibilityReadOnly: true })
      );
    ...
    test("accessibilityRequired", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("input", { accessibilityRequired: true })
      );
    ...
    test("accessibilitySelected", () => {
      ...
      const { container: hasValue } = (0, import_react.render)(
        (0, import__.default)("div", { accessibilitySelected: true })
      );
    ...
    test("focusable", () => {
      ...
      const { container: isTrue } = (0, import_react.render)((0, import__.default)("div", { focusable: true }));
      expect(getAttribute(isTrue, "tabindex")).toBe("0");
      const { container: isFalseNativelyFocusable } = (0, import_react.render)(
        (0, import__.default)("button", { focusable: false })
      );
