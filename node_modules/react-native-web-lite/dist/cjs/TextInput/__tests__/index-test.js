...
describe("components/TextInput", () => {
  ...
  describe('prop "onSelectionChange"', () => {
    ...
    test.skip("is called on change", () => {
      ...
      const { container } = (0, import_react.render)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { onSelectionChange }));
      const input = findInput(container);
  ...
  describe('prop "onSubmitEditing"', () => {
    ...
    test("multi-line input", () => {
      const onSubmitEditing = jest.fn();
      const { container } = (0, import_react.render)(
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { defaultValue: "12345", multiline: true, onSubmitEditing })
      );
      const textarea = findTextArea(container);
  ...
  describe('prop "selection"', () => {
    test("set cursor location", () => {
      ...
      const { container: defaultContainer } = (0, import_react.render)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { defaultValue: "12345" }));
