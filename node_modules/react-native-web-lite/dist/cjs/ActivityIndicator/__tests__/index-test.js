...
describe("components/ActivityIndicator", () => {
  ...
  describe('prop "animating"', () => {
    test('is "true"', () => {
      const { container } = (0, import_react.render)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { animating: true }));
      expect(container.firstChild).toMatchSnapshot();
    });
    test('is "false"', () => {
      const { container } = (0, import_react.render)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { animating: false }));
      expect(container.firstChild).toMatchSnapshot();
    });
  });
  test('prop "color"', () => {
    const { container } = (0, import_react.render)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { color: "red" }));
  ...
  describe('prop "hidesWhenStopped"', () => {
    test('is "true"', () => {
      const { container } = (0, import_react.render)(
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { animating: false, hidesWhenStopped: true })
      );
      expect(container.firstChild).toMatchSnapshot();
    });
    test('is "false"', () => {
      const { container } = (0, import_react.render)(
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { animating: false, hidesWhenStopped: false })
      );
      expect(container.firstChild).toMatchSnapshot();
    });
  });
