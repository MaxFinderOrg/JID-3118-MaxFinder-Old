...
function setupNativeSheet(platform, Implementation) {
  if (platform === "ios") {
    nativeSheets[platform] = (props) => {
      ...
      return <><SheetProvider {...providerProps} onlyShowFrame>
        <Implementation ref={ref} onModalDismiss={() => setOpen(false)}><View style={{ flex: 1 }}>{props.children}</View></Implementation>
        {
