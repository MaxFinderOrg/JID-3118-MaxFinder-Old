...
const SheetImplementationCustom = themeable(
  forwardRef(function SheetImplementationCustom2(props, forwardedRef) {
    ...
    if (modal) {
      const modalContents = /* @__PURE__ */ jsx(Portal, { zIndex, ...portalProps, children: shouldMountChildren && /* @__PURE__ */ jsx(Theme, { forceClassName: true, name: themeName, children: /* @__PURE__ */ jsx(AdaptParentContext.Provider, { value: adaptContext, children: contents }) }) });
      if (isWeb) {
